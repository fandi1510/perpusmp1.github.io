 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="http://127.0.0.1:8000/dashboard" class="brand-link">
      <img src="/adminlte/dist/img/logo.png" alt="SMPN 1 PITUMPANUA" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">SMPN 1 PITUMPANUA</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/adminlte/dist/img/orang.jpeg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
